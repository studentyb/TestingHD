...
prompta = '''Generate two python program based on the following intention.Only generate the program, not generate any explain.'''
...
for i in range(0, math.ceil(len(description) / 50)):
    ...
    for item in results:
        ...
        prompt_step2 = prompt0 + prompt3 + prompt4 + prompt5 + "The  code are" + output1[0]
    ...
    df.to_excel('.\\result\TB_chafen' + str(i) + '.xlsx', index=False)
